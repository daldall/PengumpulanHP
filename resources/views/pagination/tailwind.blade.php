                ...
                <span class="relative z-0 inline-flex rounded-lg shadow-sm">
                    ...
                    @if ($paginator->onFirstPage())
                        <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                            <span class="relative inline-flex items-center px-3 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default rounded-l-lg leading-5 select-none" aria-hidden="true">
                    ...
                    @else
                        <span aria-disabled="true" aria-label="{{ __('pagination.next') }}">
                            <span class="relative inline-flex items-center px-3 py-2 -ml-px text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default rounded-r-lg leading-5 select-none" aria-hidden="true">
                                <i class="fas fa-chevron-right w-4 h-4"></i>
                            </span>
                        </span>
                    @endif
