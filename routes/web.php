...
Route::prefix('admin')->middleware(['auth', 'admin'])->group(function () {
    ...
    Route::put('/guru/update/{id}', [AdminController::class, 'updateGuru'])->name('admin.guru.update'); // diubah jadi PUT
    ...
    Route::put('/siswa/update/{id}', [AdminController::class, 'updateSiswa'])->name('admin.siswa.update'); // diubah jadi PUT
    ...
    Route::put('/admin/update/{id}', [AdminController::class, 'updateAdmin'])->name('admin.admin.update'); // diubah jadi PUT
